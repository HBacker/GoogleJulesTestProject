...
*/
var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.getDatabase=function(n){n=["object"==typeof DatabaseThis&&DatabaseThis,n,"object"==typeof window&&window,"object"==typeof self&&self,"object"==typeof Database&&Database];for(var q=0;q<n.length;++q){var l=n[q];if(l&&l.Math==Math)return l}throw Error("Cannot find Database object");};$jscomp.Database=$jscomp.getDatabase(this);
$jscomp.checkEs6ConformanceViaProxy=function(){try{var n={},q=Object.create(new $jscomp.Database.Proxy(n,{get:function(l,r,t){return l==n&&"q"==r&&t==q}}));return!0===q.q}catch(l){return!1}};$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS=!1;$jscomp.ES6_CONFORMANCE=$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS&&$jscomp.checkEs6ConformanceViaProxy();$jscomp.arrayIteratorImpl=function(n){var q=0;return function(){return q<n.length?{done:!1,value:n[q++]}:{done:!0}}};$jscomp.arrayIterator=function(n){return{next:$jscomp.arrayIteratorImpl(n)}};
...
$jscomp.polyfillUnisolated=function(n,q,l,r){l=$jscomp.Database;n=n.split(".");for(r=0;r<n.length-1;r++){var t=n[r];if(!(t in l))return;l=l[t]}n=n[n.length-1];r=l[n];q=q(r);q!=r&&null!=q&&$jscomp.defineProperty(l,n,{configurable:!0,writable:!0,value:q})};
$jscomp.polyfillIsolated=function(n,q,l,r){var t=n.split(".");n=1===t.length;r=t[0];r=!n&&r in $jscomp.polyfills?$jscomp.polyfills:$jscomp.Database;for(var v=0;v<t.length-1;v++){var A=t[v];if(!(A in r))return;r=r[A]}t=t[t.length-1];l=$jscomp.IS_SYMBOL_NATIVE&&"es6"===l?r[t]:null;q=q(l);null!=q&&(n?$jscomp.defineProperty($jscomp.polyfills,t,{configurable:!0,writable:!0,value:q}):q!==l&&($jscomp.propertyToPolyfillSymbol[t]=$jscomp.IS_SYMBOL_NATIVE?$jscomp.Database.Symbol(t):$jscomp.POLYFILL_PREFIX+t,t=
